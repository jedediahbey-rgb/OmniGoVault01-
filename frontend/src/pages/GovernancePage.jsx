...
export default function GovernancePage({ user }) {
  ...
  const handleDeleteMeeting = async (meetingId) => {
    try {
      ...
      await api.post(`${API_V2}/records/${meetingId}/void`, {
  ...
  const handleDeleteDistribution = async (distributionId) => {
    try {
      ...
      await api.post(`${API_V2}/records/${distributionId}/void`, {
        void_reason: 'Deleted by user from governance list'
      });
  ...
  const handleDeleteDispute = async (disputeId) => {
    try {
      // Use V2 API void endpoint
      await api.post(`${API_V2}/records/${disputeId}/void`, {
        void_reason: 'Deleted by user from governance list'
      });
  ...
  const handleUpdateDisputeStatus = async (disputeId, newStatus) => {
    try {
      ...
      toast.success(`Status updated to ${disputeStatusConfig[newStatus]?.label || newStatus}`);
      fetchDisputes();
    } catch (error) {
              ...
              <GlassCard className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <div className="p-3 rounded-xl bg-green-500/20 border border-green-500/30">
                    <HandCoins className="w-8 h-8 text-green-400" weight="duotone" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-heading text-white mb-2">Create Your First Distribution</h3>
                    <p className="text-vault-muted text-sm mb-4">
                      Track and document beneficiary distributions from the trust. Record payment details, recipient information, and maintain a complete audit trail.
                    </p>
                    <ul className="text-white/50 text-sm space-y-1 mb-4">
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Document distribution amounts and recipients</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Track approval workflow and signatures</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
              ...
              <GlassCard className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <div className="p-3 rounded-xl bg-red-500/20 border border-red-500/30">
                    <Scales className="w-8 h-8 text-red-400" weight="duotone" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-heading text-white mb-2">Track Your First Dispute</h3>
                    <p className="text-vault-muted text-sm mb-4">
                      Document and manage trust-related disputes, claims, and legal matters. Keep a complete timeline of events, parties involved, and resolutions.
                    </p>
                    <ul className="text-white/50 text-sm space-y-1 mb-4">
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Track parties, claims, and counterclaims</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Document timeline of events and hearings</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
              ...
              <GlassCard className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  <div className="p-3 rounded-xl bg-amber-500/20 border border-amber-500/30">
                    <CurrencyDollar className="w-8 h-8 text-amber-400" weight="duotone" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-heading text-white mb-2">Log Your First Compensation</h3>
                    <p className="text-vault-muted text-sm mb-4">
                      Track trustee fees, advisor compensation, and professional service payments. Maintain accurate records for tax and fiduciary compliance.
                    </p>
                    <ul className="text-white/50 text-sm space-y-1 mb-4">
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Document trustee and advisor fees</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
                        <span>Track payment schedules and methods</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Check className="w-4 h-4 text-green-400" />
        ...
        <DialogContent className="bg-[#0B1221] border-vault-gold/30 text-white max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <LedgerThreadSelector
              ...
              moduleType="minutes"
              selectedSubject={meetingThread}
              onSubjectChange={setMeetingThread}
            />
