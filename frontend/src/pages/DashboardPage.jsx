...
export default function DashboardPage({ user }) {
  ...
  const allQuickActions = [
    // Primary actions
    { id: 'newdocument', icon: Notebook, label: 'New Document', action: () => navigate('/templates'), color: 'gold' },
    // Knowledge
    ...
    { id: 'diagrams', icon: Graph, label: 'Diagrams', action: () => navigate('/diagrams'), color: 'gold' },
    // Workspace
    ...
    { id: 'templates', icon: StackSimple, label: 'Templates', action: () => navigate('/templates'), color: 'gold' },
    // Tools
    ...
    { id: 'threads', icon: FlowArrow, label: 'Threads', action: () => navigate('/ledger-threads'), color: 'gold' },
                ...
                {portfolios.map((portfolio) => {
                  ...
                  return (
                    <StyledPortfolioCard
                      ...
                      portfolio={portfolio}
                      isDefault={isDefault}
                      styleId={portfolio.style_id || 'standard'}
                      onSetDefault={setAsDefault}
                      onClearDefault={clearDefault}
                      onEdit={openEditDialog}
                      onDelete={deletePortfolio}
                      onCustomize={openStyleSelector}
                    />
                  );
                })}
              </div>
