    ...
    <AnimatePresence>
      {shouldShow && (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-5 px-8 py-8 rounded-2xl bg-vault-navy/60 backdrop-blur-sm border border-vault-gold/10 w-[300px] h-[320px]">
            {/* Logo / Wordmark */}
            <motion.div
